                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive" style="overflow-x:hidden;">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                        <label for="scanaktekelahiran" class=" form-control-label">Scan Ijazah Bagian Depan</label>
                                                        <img src="../user/<?php echo $ambil['scanaktekelahiran']?>" width="50%">
                                                    </div>
                                                </div>
                                            <div class="col">
                                                <div class="form-group">
                                                        <label for="scankartukeluarga" class=" form-control-label">Scan Ijazah Bagian Belakang</label>
                                                        <img src="../user/<?php echo $ambil['scankartukeluarga']?>" width="50%">
                                                </div>
                                            </div>
                                        </div>
